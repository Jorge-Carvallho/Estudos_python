...
nome = 'extraordinario'
# Exercícios sobre Manipulação de Índices em Strings
# Comprimento da String
print(len(nome))

# Crie uma variável chamada palavra e atribua a ela a string "incrível".
# Utilize a função para imprimir o comprimento da string.
# Acesso ao Primeiro Caractere
palavra = 'incrivel'
print(len(palavra))
print(palavra[0])
...
# Acesse e imprima o primeiro caractere da string.
# Acesso ao Último Caractere
print(palavra[0])

# Acesse e imprima o último caractere da string usando indexação negativa.
# Slice dos Primeiros 5 Caracteres
print(palavra[-1])
print(palavra[:5])

# Faça um slice que capture e imprima os primeiros 5 caracteres da string.
# Slice a Partir do Índice 3
print(palavra[:5])
print(palavra[3:])

# Faça um slice que capture e imprima a string a partir do índice 3 até o final.
# Slice Até o Índice 4 (Não Incluído)
print(palavra[3:])
print(palavra[:4])

# Faça um slice que capture e imprima a string até o índice 4 (não incluído).
# Slice Completo da String
print(palavra[:4])
print(palavra[:])

# Faça um slice que capture e imprima toda a string.
# Slice com Passo de 2
print(palavra[:])
print(palavra[::2])

# Faça um slice que capture e imprima a string a partir do índice 2 até o índice 7, com passo de 2.
# Slice com Passo de 3
print(palavra[2:7:2])
print(palavra[::3])
# Faça um slice que capture e imprima a string do início ao fim, com passo de 3.
